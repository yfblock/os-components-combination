...
impl BootSector {
    pub(crate) fn deserialize<R: Read + Seek>(rdr: &mut R) -> Result<Self, R::Error> {
        ...
        println!("is fat32: {}", boot.bpb.is_fat32());
        ...
        println!("seek: {}", rdr.seek(crate::SeekFrom::Current(0)).unwrap());
